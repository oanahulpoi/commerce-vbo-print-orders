...
<div class="invoice-invoiced">
  ...
  <div class="invoice-info">
  	  <div class="invoice-number"><?php print render($content['invoice_number']); ?></div>
  ...
  <div class="invoice-text">
    ...
    <br/>
    <p>
        Facturat în baza comenzii numărul <strong><?php print render($content['order_id']); ?></strong> din <strong><?php print render($content['order_created_date']);?></strong> plasată pe zdravan.ro.
        <br/>
